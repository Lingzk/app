...
/* 这些代码颜色都一样。加点儿高亮区别来 */
.token.selector{ color: #5C527F}
.token.property{ color: #AE00FB }
.token.punctuation{ color: #F25287 }
.token.function{ color: #001E6C }
.token.comment{ color: #09A599 }
/* 加个 3D 效果 */
html{
